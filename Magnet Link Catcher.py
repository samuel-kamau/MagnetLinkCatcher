...
main_layout = [
    ...
    [sg.Text("  Magnet Link Catcher", font=("Segoe UI Light", 24),
             text_color="#5d2b90", justification="left")],
    ...
    [sg.Text("  "), sg.Button("Support this project", size=(17, 0), font=("Segoe UI Light", 10, "bold")),
        sg.VerticalSeparator(pad=(6, 3)), sg.Button(
            "About", size=(7, 0), font=("Segoe UI Light", 10, "bold")),
        sg.VerticalSeparator(pad=(6, 3)), sg.Button("Exit", size=(12, 0), font=("Segoe UI Light", 10, "bold"))],
    [sg.Text("\nDeveloped by Pedro Lemos (@pedrolemoz)", font=(
        "Segoe UI Light", 12), size=(42, 0), justification="center")]
]
    ...
    if event == "Search":
        ...
        results_layout=[
            ...
            [sg.Text(" " * 16), sg.Button("Save all links to file", size=(22, 0), font=("Segoe UI Light", 10, "bold")),
             sg.Button("Open magnet link", size=(16, 0),
                       font=("Segoe UI Light", 10, "bold")),
             sg.Button("Copy magnet link", size=(16, 0),
                       font=("Segoe UI Light", 10, "bold")),
        ...
        while True:
            ...
            if results_event == "Save all links to file":
                ...
                save_layout = [
                    [sg.Text("\n", font=("Segoe UI Light", 5))],
                    [sg.Text(f"Magnet links saved sucessfully!", size=(
                        25, 0), font=("Segoe UI Light", 14), justification="left")],
                    [sg.Text("\n", font=("Segoe UI Light", 1))],
